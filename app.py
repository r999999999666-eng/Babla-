...
def start(msg):
    ...
    # 1. Сбрасываем ожидание всех шагов
    bot.clear_step_handler_by_chat_id(chat_id)
    
    # 2. Отменяем активные таймеры
    ...
    # 3. Очищаем прошлые сообщения
    clear_user_messages(chat_id)

    # 4. Сброс временных данных
    ...
    welcome_text = f"""Привет, <b>{BOT_NAME}</b>! 👋

Пополнение и выводы 🔼🔽

🛡 <b>Защищенные транзакции</b>

🛫 <b>Пополнение:</b> 5-15 сек 
☄️ <b>Быстрые выводы</b>

✔️ Работаем <b>24/7</b>!

✍️ <b>Оператор:</b> {SUPPORT}"""
